...
from apps.membership.serializers.serializers_v1 import *
...
class MembershipViewSet(ModelViewSet):
        ...
        examples=[
            OpenApiExample(
                ...
                "user": "string",
                 ...
                 "additional_club_position": "string",
                 "status": "string",
                 "recruitment_semester": "string",
                 "remarks": "string",
                },
                request_only=True,
            )
    ...
    @transaction.atomic()
    @allowed_users(allowed_roles=['GENERAL'])
    ...
    def update(self, request, *args, **kwargs):
        ...
        if not instance:
            return Response({'message': 'Invalid Membership'}, status=status.HTTP_400_BAD_REQUEST)
    ...
    @extend_schema(parameters=set_query_params('list', [
        ...
        {"status": 'status', "description": 'Filter by status'},
         {"club_position": 'club_position', "description": 'Filter by club position'},
           {"additional_club_position": 'additional_club_position', "description": 'Filter by additional club position'},
